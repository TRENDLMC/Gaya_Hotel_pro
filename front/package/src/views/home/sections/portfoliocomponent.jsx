                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="7" className="text-center">
                            ...
                            <h6 className="subtitle">가야호텔은 대한민국에서 제일좋은 오션뷰를 자랑합니다</h6>
                        </Col>
                    </Row>
                        ...
                        <Col md="4">
                            <Card className="card-shadow">
                                ...
                                <CardBody>
                                    ...
                                    <p className="m-b-0 font-14">호텔 레스토랑에서 최고의 맛을 경험하세요</p>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col md="4">
                            <Card className="card-shadow">
                                ...
                                <CardBody>
                                    ...
                                    <p className="m-b-0 font-14">최고의 서비스를 호텔에서 경험하세요</p>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col md="4">
                            <Card className="card-shadow">
                                ...
                                <CardBody>
                                    ...
                                    <p className="m-b-0 font-14">호텔에서 다양한 액티비티 프로그램을 한번에 경험하세요</p>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col md="4">
